...
# (HINT: There are two different syntax used for hashes here. What's the difference?) 
# I refer to this giant hash as a "hashy hash;" why do you think that is? What kind of variable is STATE_DATA, and what's its scope?

# This hash includes three pieces of data for each key-value pair: a single key, which consists of a State name, and 
# two two-part values.  This "hashy hash" consists of a hash within the hash:
# the value is a hash in itself, containing two key-value pairs.  STATE_DATA is a global variable.  This variable can
# be used at any point in the file that requires it.
